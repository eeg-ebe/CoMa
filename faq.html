...
![Conspecificity matrix with 30 chimpanzees and 9 bonobos](/blob/gh-pages/matrix_bonobos_chimps.png)
                 
A similarly clear-cut conspecificity matrix can be found in a recent study of giraffes by [Petzold & Hassanin (2020)](https://doi.org/10.1371/journal.pone.0217956): it shows clearly three squares of high conspecificity scores along the diagonal, separated from other clusters by low conspecificity scores. This reveals that there are three species of giraffes in Petzold & Hassanin's dataset.

![Conspecificity matrix showing three species of giraffes](/blob/gh-pages/matrix_giraffes.png)
